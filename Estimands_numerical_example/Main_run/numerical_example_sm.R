...
scen = 1; tau = 1; n.sample = 100000; dim_x = 1 # n.sample = 30000000 
...
for (i in 1:length(scen_vec)) {
  print(i)
  my.data_generation = Data_generation_func(scen=scen_vec[i], rho=rho_vec[i], 
                                            tau=tau, n.sample=n.sample, dim_x=dim_x)
...
'''supp_sum_my.data_lst = sum_my.data_lst
save(supp_sum_my.data_lst, file = "supp_sum_my.data_lst.RData")'''

simple_my.data_lst <- lapply(sum_my.data_lst, function(sublist) {
...
all_estimands_mat_fig$Scen_grp[all_estimands_mat_fig$Scen_grp %in% c("611", "612", "613")] = "Scen~A" # c("1", "3") # c("611", "612", "613")
all_estimands_mat_fig$Scen_grp[all_estimands_mat_fig$Scen_grp %in% c("511", "512", "513")] = "Scen~B" # c("5", "9") # c("511", "512", "513")]
